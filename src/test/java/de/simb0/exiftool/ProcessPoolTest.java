...
public class ProcessPoolTest {
    ...
    private ProcessPool testee = ProcessPool.buildPool(Paths.get("any"), poolSize, 5);

    @Test
    public void testCreatePool() {
        assertThat(testee.size()).isEqualTo(poolSize);
    }
    ...
    public void testRelease() {
        testee = ProcessPool.buildPool(Paths.get("any"), poolSize, 5);
        for (int i = 0; i < poolSize-1; i++) {
            assertThat(testee.get()).isNotNull();
        }
